...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Self::check_title_validity(&title);
        Self::check_description_validity(&description);
    ...
    pub fn set_title(&mut self, new_title: String) {
        Self::check_title_validity(&new_title);
        self.title = new_title;
    }

    pub fn set_description(&mut self, new_description: String) {
        Self::check_description_validity(&new_description);
        self.description = new_description;
    }

    pub fn set_status(&mut self, new_status: String) {
        Self::check_status_validity(&new_status);
        self.status = new_status;
    }

    fn check_title_validity(new_title: &String) {
    ...
    fn check_description_validity(new_description: &String) {
    ...
    fn check_status_validity(new_status: &String) {
